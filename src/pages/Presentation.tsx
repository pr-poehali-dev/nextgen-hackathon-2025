              ...
              <Card className="bg-green-50 border-green-300">
                <CardContent className="p-6 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-green-700">300,000 ₽</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Гранты</span>
                    <span className="font-bold text-green-700">200,000 ₽</span>
                  </div>
                  <div className="border-t border-green-300 pt-3 flex justify-between items-center">
                    <span className="font-bold">ИТОГО</span>
                    <span className="font-bold text-2xl text-green-700">500,000 ₽</span>
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="bg-orange-50 border-orange-300">
                <CardContent className="p-6 space-y-2 text-sm">
                  ...
                  <div className="border-t border-orange-300 pt-2 flex justify-between items-center">
                    <span className="font-bold">ИТОГО</span>
                    <span className="font-bold text-xl text-orange-700">500,000 ₽</span>
                  </div>
                </CardContent>
              </Card>
            </div>
